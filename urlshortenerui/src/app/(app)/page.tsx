...
export default function Home() {
  return (
    <div className="items-center justify-center bg-black text-white">
      ...
      <section id="feature_section" className="px-30 py-4 mt-10 flex flex-col gap-12">
        <div className="flex justify-between">
          <div className="flex flex-col items-center w-80 gap-2">
            <ThumbsUp size={50} strokeWidth={2} color="#c96442" />
          ...
          <div className="flex flex-col items-center w-80 gap-2">
            <LinkIcon size={50} strokeWidth={2} color="#c96442" />
          ...
          <div className="flex flex-col items-center w-80 gap-2">
            <ShieldCheck size={50} strokeWidth={2} color="#c96442" />
        ...
        <div className="flex justify-between">
          <div className="flex flex-col items-center w-80 gap-2">
            <ChartCandlestick size={50} strokeWidth={2} color="#c96442" />
          ...
          <div className="flex flex-col items-center w-80 gap-2">
            <Hand size={50} strokeWidth={2} color="#c96442" />
          ...
          <div className="flex flex-col items-center w-80 gap-2">
            <TabletSmartphone size={50} strokeWidth={2} color="#c96442" />
      ...
      <footer className="mb-5 text-center text-lg font-outfit">
